...
from . import kmeans, dbscan, hdbscan, dbscan_3param, dbscan_3param_norm, hdbscan_3param_norm
...
all_classifiers: dict[str, type[FamilyClassifier]] = {
    ...
    "hdbscan_3param_norm": hdbscan_3param_norm.HDBSCAN3NormFamilyClassifier,
}
