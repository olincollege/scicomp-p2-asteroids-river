...
class DBSCAN3NormFamilyClassifier(FamilyClassifier):
    """
    ...
    def __init__(self, eps: float = 0.01, min_samples: int = 5):
        """
        Initialize the DBSCAN3NormFamilyClassifier with the given parameters.
    ...
    def classify(self, elements: pd.DataFrame) -> pd.DataFrame:
        ...
        results = self.dbscan.fit_predict(data_normalized)
